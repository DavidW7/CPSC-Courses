...
/* Detach a uthread. This prevents the thread from being joined. When the detached
thread exits, it will automatically be freed. join and detach are mutually exclusive. */
