...
namespace filler
{
        ...
        */
        ...
        bool isPointValid(int x, int y, int cX, int cY, int k, int width, int height);

        void sendFrame(int pointsAdded, int frameFreq, animation a, PNG new_img);

        void check_neighbours(point p, OrderingStructure<point>& curOS, 
                            PNG new_img, vector<vector<bool>> unprocessedPoints, 
                            int pointsAdded, int frameFreq, colorPicker& fillColor, animation a);

        void processPoint(point p, PNG new_img, vector<vector<bool>> unprocessedPoints,
                          int pointsAdded, int frameFreq, colorPicker& fillColor, animation a);
